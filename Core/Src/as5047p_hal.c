...
static SPI_HandleTypeDef *handlerSPI;
...
//#error "You must implement AS5047P_HAL_Delay_ms()"
}
...
//  }
  ...
  return 0;
	...
	//Remove this line after implementation!
//#error "You must implement AS5047P_HAL_SPI_TxRx()"
}
...
{
// Write state to currently selected output
	HAL_GPIO_WritePin(gpioPort, gpioPin, state);

	//Remove this line after implementation!
//#error "You must implement AS5047P_HAL_GPIO_Write()"
}
...
static uint8_t AS5047P_SelectSPIAndGPIO(uint16_t id)
{
  ...
  return 0;
	...
	//Remove this line after implementation!
//#error "You must implement AS5047P_SelectSPIAndGPIO()"
}
